...
import hh from "/public/assets/images/image-omelette.jpeg";
...
const index = () => {
  return (
    <div>
      <Image src={hh} alt="hh"  className="w-full h-96b md:rounded-xl " />
      <div className="p-8 flex flex-col gap-6">
         <h1 className="text-3xl font-youngSerif font-medium"> Simple Omelette Recipe</h1>
